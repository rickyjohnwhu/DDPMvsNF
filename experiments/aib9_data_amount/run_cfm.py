...
def run(args):
    ...
    output_path = f"output/cfm/aib9_lim={args.dataset_limiter}_seed={args.seed}"
...
#SBATCH --job-name=cfm_aib9_lim
#SBATCH --output=logs/cfm/aib9-lim-{dataset_limiter}-seed-{seed}.out
