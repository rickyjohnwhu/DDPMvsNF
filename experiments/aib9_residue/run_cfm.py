...
def run(args):
    ...
    output_path = f"output/cfm/aib9_seed={args.seed}"
...
#SBATCH --job-name=cfm_aib9
#SBATCH --output=logs/cfm/aib9-seed-{seed}.out

source $MAMBA_ROOT_PREFIX/etc/profile.d/micromamba.sh
micromamba activate compenv

python run_cfm.py --config config/config_cfm.yml --seed {seed} --slurm_run
"""
