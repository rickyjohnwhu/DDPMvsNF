...
def run(args):
    ...
    output_path = f"output/ns/aib9_seed={args.seed}"
...
#SBATCH --job-name=ns_aib9
#SBATCH --output=logs/ns/aib9-seed-{seed}.out

source $MAMBA_ROOT_PREFIX/etc/profile.d/micromamba.sh
micromamba activate compenv

python run_ns.py --config config/config_ns.yml --seed {seed} --slurm_run
"""
